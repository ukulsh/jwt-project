...
class Token:
    ...
    def __init__(self, token=None, verify=True):
        ...
        self.token = token
        self.current_time = token.check_exp
    ...
    def check_exp(self, claim='exp', current_time=None):
        ...
        try:
            ...
            raise TokenError((_("Token has no '{}' claim"), claim))

        claim_time = (claim_value)
        if claim_time <= current_time:
            raise TokenError((_("Token '{}' claim has expired"), claim))
...
class UntypedToken(Token):
    ...
    def verify_token_type(self):
        ...
        when performing general validation of a token's signature
